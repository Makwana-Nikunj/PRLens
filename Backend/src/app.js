...
const defaultOrigins = ["http://localhost:5173", "http://localhost:5174", "http://127.0.0.1:5173", "https://prlens-eight.vercel.app"];
...
// Skip compression for SSE streams — they must flush immediately
app.use(compression({
    filter: (req, res) => {
